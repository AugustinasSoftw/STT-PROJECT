...
async def scrape_latest_100() -> list[dict]:
    async with async_playwright() as p:
        ...
        for row in row_handles:
            ...
            # other columns
            procedure_type = ((await cells[2].text_content()) or "").strip()
...
UPSERT_SQL = """
INSERT INTO awards (
    notice_id, title, buyer_name, procedure_type, publish_date, notice_url
) VALUES (%s,%s,%s,%s,%s,%s)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"✅ Inserted/updated {count} rows into awards.")
